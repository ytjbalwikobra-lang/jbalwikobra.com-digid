            ...
            <div className="space-y-4">
              <div className="flex justify-center mb-6">
                <div className="relative">
                  <div className="w-16 h-16 bg-gradient-to-r from-[var(--cyber-pink-primary)] to-[var(--cyber-pink-glow)] rounded-3xl flex items-center justify-center shadow-2xl shadow-[var(--cyber-pink-muted)]">
              ...
              <PNText className="max-w-3xl mx-auto">
                ...
                <span className="text-[var(--cyber-pink-primary)] font-medium"> JB Alwikobra</span>
              </PNText>
            </div>
          </div>
        </div>
