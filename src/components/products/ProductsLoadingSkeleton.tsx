...
export const ProductsLoadingSkeleton = React.memo(() => (
  <div className="min-h-screen bg-[var(--cyber-bg-pure)]">
    ...
    <div className={standardClasses.container.boxed}>
      <div className="h-8 bg-[var(--cyber-bg-card)] rounded-xl w-48 mb-4 animate-pulse"></div>
      <div className="h-10 bg-[var(--cyber-bg-card)] rounded-xl mb-4 animate-pulse"></div>
    </div>
    
    {/* Filter bar skeleton */}
    <div className={standardClasses.container.boxed}>
      <div className="flex space-x-3">
        <div className="h-10 bg-[var(--cyber-bg-card)] rounded-xl flex-1 animate-pulse"></div>
        <div className="h-10 w-10 bg-[var(--cyber-bg-card)] rounded-xl animate-pulse"></div>
      </div>
    </div>
    ...
    <div className={standardClasses.container.boxed}>
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        {[...Array(8)].map((_, i) => (
          <div key={i} className="bg-[var(--cyber-bg-pure)]/50 rounded-2xl p-3 animate-pulse">
            <div className="aspect-square bg-[var(--cyber-bg-card)] rounded-xl mb-3"></div>
            ...
            <div className="h-8 bg-[var(--cyber-bg-card)] rounded-xl"></div>
          </div>
        ))}
      </div>
    </div>
