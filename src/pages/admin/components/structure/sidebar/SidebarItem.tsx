    ...
    <div className="relative group">
      ...
      >
        <Icon className={`
          ...
          ${isActive ? 'text-white' : 'text-[var(--cyber-pink-primary)]'}
        `} />
      ...
      {collapsed && (
        <div className="absolute left-full ml-2 px-3 py-2 bg-surface-glass-dark text-white text-sm rounded-cyber-lg opacity-0 group-hover:opacity-100 transition-all duration-200 pointer-events-none whitespace-nowrap z-50 border border-surface-tint-light shadow-xl">
          {label}
